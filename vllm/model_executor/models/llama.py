...
class LlamaForSequenceClassification(nn.Module, SupportsLoRA, SupportsPP):
    packed_modules_mapping = {
        "qkv_proj": [
            "q_proj",
            "k_proj",
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self._pooler = Pooler.from_config_with_defaults(
            pooler_config, pooling_type=PoolingType.LAST, normalize=False, softmax=False
        )
...
class LlamaForCausalLMAndClassification(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = LlamaModel(
            vllm_config=vllm_config, prefix=maybe_prefix(prefix, "llama")
        )
    ...
    def forward(
        ...
        if lm_outputs:
            logits = self.logits_processor(
                self.lm_head, hidden_states, attn_metadata.sampling_metadata
            )
